...
namespace balance_dp.Models
{
    ...
    {
       public InputParametrs InputData { get; set; }
    ...
    public class CastIronElementsPercent // Состав чугуна и его характеристики
    {
        ...
        float list1_C18_CastIronHeatCapacity { get; set; } = 0.9f; // в КИЛОДЖОУЛЯХ!
    ...
    public class  BlastFurnace // Доменная печь и её характеристики
    {
        ...
        public float list1_C24_HeatLoses_ofBlastFurnace
        {
            set 
            {
    ...
    public class COCKsComposition 
    {
        ...
        private float snellvalue;
        public float list2_D42_Snell { set 
            {
                snellvalue = 100 - (list2_A42_AhsCocks + list2_B42_SulfurCocks + list2_C42_LiquidCocks);
            }
            get { return snellvalue;  }
        }
    ...
    public class BlowingParams
    {
        ...
        private float naturalblowingconsuption;
        public float list2_D42_Snell
        {
            set
            {
                naturalblowingconsuption = list1_C35_NaturalBlowingConsumption + list1_C34_BlowingMoisture;
            }
            get { return naturalblowingconsuption; }
        }
    ...
    public class Slag
    {
        ...
        private float CaoSio2 {get; set;}
        public float list1_C59_CaOSiO2_Capacity {  
        
        set
        {
                CaoSio2 = list1_C53_CaO_Capacity / list1_C54_SiO2_Caacity;
        }
            get { return CaoSio2; }
        }
    ...
    public class BlastFurnaceGas //Koloshnikovyi
    {
        ...
        public float list1_C65_N2_Capacity
        {
             set 
             { 
                n2_capacity = 100 - (list1_C62_CO2_Capacity + list1_C63_CO_Capacity + list1_C64_H2_Capacity);
             }
            get { return n2_capacity; }
        }
